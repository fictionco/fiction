...
<template>
  <div class="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-2">
    <div
      class="from-theme-0 to-theme-100 via-theme-0 text-theme-800 border-theme-300 relative overflow-hidden rounded-lg border bg-gradient-to-b"
    >
      <div
        class="relative inset-0 z-30 flex h-full flex-col justify-center p-6"
      >
        <div class="text-4xl font-bold">
          Andrew Powers
        </div>
        <div class="my-8 text-xl">
          Andrew Powers is a serial founder and innovator. Building companies in
          software and AI.
        </div>
        <div>
