    ...
    <div class="checkout">
      <div v-if="!status" class="header">
        ...
        <div class="action">
          ...
          >
          <factor-link v-else :query="{ ...$route.query, interval: `month` }"
            >Pay Monthly Instead</factor-link
          >
      ...
      <div v-if="status == 'success'" class="status-info">
        <div class="success">
          ...
          <div class="action">
            <factor-link btn="primary" path="/docs/pro-suite"
              >Using {{ productConfig.title }} &rarr;</factor-link
            >
            <factor-link btn="default" path="/dashboard/developer"
              >Developer Dashboard &rarr;</factor-link
            >
          </div>
        </div>
      </div>
        ...
        <div class="checkout-col payment-info">
          <div class="payment-area">
            ...
            <div class="item terms">
              ...
              agreeing to the
              <factor-link path="/terms-of-service"
                >terms of service</factor-link
              >.
            </div>

            <div class="item coupon">
              <div v-if="!toggleCode" class="label" @click="toggleCode = true">
                Add Code
              </div>
