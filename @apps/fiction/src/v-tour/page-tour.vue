      ...
      <div class="content-pad">
        <div class="content-width">
          <div class="testimonial">
            ...
            <blockquote>
              <p>We chose the Factor JS platform (built with VueJS, MongoDB) for the new company app and it's been an awesome experience guys. Incredible work @fictiondotcom! 🚀</p>
