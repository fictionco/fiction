                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <div
                            class="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-primary-500 text-white sm:h-12 sm:w-12"
                          >
            ...
            <div class="pt-5 pb-6 px-5">
              <div class="flex items-center justify-between">
                <div>
                  <img
                    class="h-8 w-auto"
                    src="https://tailwindui.com/img/logos/workflow-mark-purple-600-to-primary-600.svg"
                    alt="Workflow"
                  />
                </div>
                <div class="-mr-2">
              ...
              <div class="mt-6">
                <nav class="grid grid-cols-1 gap-7">
                  <a
                    href="#"
                    class="-m-3 p-3 flex items-center rounded-lg hover:bg-color-50"
                  >
                    <div
                    ...
                    <div class="ml-4 font-semibold">Inbox</div>
                  </a>
                  ...
                  >
                    ...
                    <div class="ml-4 font-semibold">Messaging</div>
                  </a>
                  ...
                  >
                    ...
                    <div class="ml-4 font-semibold">Live Chat</div>
                  </a>
                </nav>
              </div>
            </div>
