      ...
      <div class="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
            ...
            <div class="">
              ...
              <div class="mt-6 sm:max-w-xl">
                ...
                <p class="mt-6 text-xl text-color-500">
                  A next-generation JavaScript framework you can use to create
                  blogs, landing pages, and JAMStack apps.
                </p>
              </div>
        ...
        <div class="sm:mx-auto sm:max-w-3xl">
          <div
            ...
            "
          >
            <FigureSplash class="absolute inset-8 mb-16 lg:mt-16 lg:mb-0" />
          </div>
        </div>
      </div>
    </div>
