    ...
    <template #nav>
      <div class="onboard-menu">
        ...
        <div class="menu-items">
          <div v-for="(item, i) in menu" :key="i" class="item">
            <div class="icon">
              <div class="icon-wrap">
...
export default {
  ...
  data() {
    return {
      menu: [
        { name: "Welcome", query: { step: 1 } },
        { name: "Add Website", query: { step: 2 } },
        { name: "Tracking Script", query: { step: 3 } },
        { name: "Invite Team", query: { step: 4 } },
      ],
    }
  },
}
