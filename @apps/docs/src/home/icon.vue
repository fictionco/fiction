<template>
  <figure class="icon">
    <svg v-if="icon == 'ssr'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
      <title>ssr</title>
      <circle cx="36" cy="36" r="36" style="fill:#d2eeff" />
      <path
    ...
    <svg v-else-if="icon == 'powered'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
      ...
      <circle
        ...
        cy="36.7"
        r="15.95"
        style="fill:none;stroke:#8eccfd;stroke-miterlimit:10;stroke-width:2px"
      />
      <path
    ...
    <svg v-else-if="icon == 'dashboard2'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
      ...
      <circle cx="36" cy="36" r="36" style="fill:#d2eeff" />
      <path d="M50.52,45.94a16.54,16.54,0,1,0-29,0Z" style="fill:#0496ff;opacity:0.4" />
      <path
