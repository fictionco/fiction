<template>
  <figure class="icon">
    <svg v-if="icon == 'ssr'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
      ...
      <path
        d="M24.68,20.53H47.32a3.23,3.23,0,0,1,3.23,3.23V27a3.23,3.23,0,0,1-3.23,3.23H24.68A3.23,3.23,0,0,1,21.45,27V23.76A3.23,3.23,0,0,1,24.68,20.53Z"
        style="fill:#b3bdc4"
      />
      <path
        d="M24.68,31.85H47.32a3.22,3.22,0,0,1,3.23,3.23v3.24a3.23,3.23,0,0,1-3.23,3.23H24.68a3.23,3.23,0,0,1-3.23-3.23V35.08A3.22,3.22,0,0,1,24.68,31.85Z"
        style="fill:#b3bdc4"
      />
      <path
        d="M24.68,43.17H47.32a3.22,3.22,0,0,1,3.23,3.23v3.23a3.23,3.23,0,0,1-3.23,3.24H24.68a3.23,3.23,0,0,1-3.23-3.24V46.4A3.22,3.22,0,0,1,24.68,43.17Z"
        style="fill:#506677"
      />
    </svg>
    <svg
    ...
    <svg
      ...
      viewBox="0 0 64 64"
    >
      <path d="M3.79,3.81H26.28v30H3.79Z" style="fill:#8eccfd"></path>
      <path d="M60.2,30.21v30.1H37.71V30.21Z" style="fill:#8eccfd"></path>
      <path d="M37.71,3.8H60.2v15H37.71Z" style="fill:#8eccfd"></path>
      <path d="M26.28,45.25v15H3.78v-15Z" style="fill:#8eccfd"></path>
      <path d="M30.05,37.63H0V0h30ZM3.76,3.8v30h22.5V3.8Z" style="fill:#0496ff"></path>
      <path
        d="M64,64H34V26.46H64ZM60.2,30.21H37.72V60.26H60.2Z"
        style="fill:#0496ff"
      ></path>
      <path d="M64,22.53H34V0H64ZM37.71,3.79v15h22.5v-15Z" style="fill:#0496ff"></path>
      <path
        d="M0,64V41.48H30.08V64ZM26.28,45.25H3.78v15h22.5Z"
        style="fill:#0496ff"
      ></path>
    </svg>
    <svg
