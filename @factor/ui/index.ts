import type { FactorApp, FactorPluginSettings, vue } from '@factor/api'
import { FactorPlugin, safeDirname } from '@factor/api'
import twForms from '@tailwindcss/forms'
import twContainerQueries from '@tailwindcss/container-queries'
import { tailwindVarColorScheme } from '@factor/api/utils/colors'
