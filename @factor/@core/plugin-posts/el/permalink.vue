<template>
  <div class="permalink" @click.stop>
    ...
    <div v-if="!toggleValue" class="edit-actions">
      <factor-btn size="tiny" class="edit" @click="setToggle()">Edit Permalink</factor-btn>
      <factor-btn size="tiny" class="edit" @click="updateFromInitial()">Update from Title</factor-btn>
    </div>
  </div>
</template>
<script>
