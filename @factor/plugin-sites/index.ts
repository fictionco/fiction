// @unocss-include
import { FactorPlugin, safeDirname, vue } from '@factor/api'
import type { DataFilter, FactorApp, FactorRouter, IndexMeta } from '@factor/api'

import { EnvVar, vars } from '@factor/api/plugin-env'
import type { FactorAdmin, FactorAdminSettings } from '@factor/plugin-admin'
import type { PluginMain } from '@factor/plugin-admin-index'
