...
const socialList: NavItem[] = [
  ...
  {
    key: 'facebook',
    href: 'https://www.facebook.com/pagelines',
    target: '_blank',
    name: 'Facebook',
  ...
  {
    key: 'github',
    href: 'https://github.com/pagelines',
    target: '_blank',
    name: 'Github',
  ...
  {
    key: 'twitter',
    href: 'https://www.twitter.com/pagelines',
    target: '_blank',
    name: 'Twitter',
...
export function setup(args: ServiceList) {
  const pages = [getHomePage(args), tourPage, ...legalPages]
