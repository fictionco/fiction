...
import { getNav, socialList } from './nav'
                ...
                <div class="my-4">
                  <div class="sub-menu font-brand">
                    <component
                      ...
                      :href="item.value"
                      role="menuitem"
                      class="group grid grid-cols-12 items-center rounded-md px-3 py-2 text-lg hover:bg-color-50 hover:text-primary-500"
                    ...
                    >
                      ...
                      <span class="col-span-10" v-html="item.name" />
                    </component>
                  </div>
                </div>
              </template>
