...
import { colorStandard, vue } from '@factor/api'
...
const props = defineProps({
  ...
  format: { type: String as vue.PropType<'hero' | 'splash'>, default: '' },
})

const dashboardImage = vue.computed(() => {
...
<template>
  ...
  >
    <div v-if="featureId === 'inbox'" class="absolute -bottom-12 -left-12 z-20">
      <div
        class="text-theme-800 w-56 rounded-lg bg-white p-6 text-left text-sm shadow-xl ring-1 ring-black/5"
      >
        <img
          class="mb-4 w-12"
          :src="LogoTesla"
    ...
    <div v-if="featureId === 'contacts'" class="absolute -bottom-12 z-10">
      <div
    ...
    <div
      ...
      class="absolute -bottom-16 -right-4 z-10"
    >
    ...
    <template v-else-if="featureId === 'home'">
      <FigureNps
        class="nps-figure absolute -left-10 bottom-12 z-10 shadow-lg md:-left-24"
      />
      <FigureCsat
        class="csat-figure absolute -bottom-4 -right-10 z-10 md:-right-24"
      />
    </template>
    ...
    <template v-else-if="featureId === 'live'">
      ...
      <div class="absolute -bottom-16 -right-24 z-10 hidden md:block">
    ...
    <img
      ...
      class="z-0 mx-auto w-full max-w-[80rem] rounded-lg bg-white shadow-lg ring-1 ring-black/10 md:max-w-2xl"
      :src="dashboardImage"
    >
  </div>
</template>
