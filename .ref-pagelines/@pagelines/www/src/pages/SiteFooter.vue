...
import { socialList } from '../content'
...
<template>
  <footer class="z-10 mx-auto mt-6 w-full max-w-screen-xl py-12">
    <div class="mx-auto max-w-7xl px-4 lg:px-0">
      <div class="">
        <div class="flex flex-col justify-between py-16 sm:flex-row lg:px-12">
          <div class="w-80 py-6 text-center sm:mx-auto md:py-1">
            <a href="https://www.pagelines.com">
              <ElIcon class="w-8" />
            </a>
          </div>
          <div class="grid grow grid-cols-12 gap-x-8 gap-y-12">
            ...
            >
              <h3
                v-if="col.heading"
                class="text-theme-400 mb-6 text-left text-xs font-medium uppercase tracking-wider"
              >
                {{ col.heading }}
              </h3>
              <ul v-if="col.menu" :class="col.class ? col.class : 'space-y-2'">
                ...
                >
                  <a
                    ...
                    class="hover:text-primary-500 text-theme-800 text-base"
                  >
                    {{ item.name }}
                  </a>
                </li>
        ...
        <div class="mt-12">
          ...
          <div class="mt-8 text-center">
            <a
              ...
              class="text-theme-300 hover:text-theme-800 inline-block"
            >
              <ElIcon class="w-8" />
            </a>
          </div>
      ...
      <div
        class="hidden flex-col pb-12 text-center text-sm lg:flex-row lg:items-center lg:justify-between"
      >
