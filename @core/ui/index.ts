...
export const inputTheme = (theme: InputColorTheme = "standard"): string => {
  if (theme == "overlay") {
    ...
    return "border-bluegray-400 placeholder:text-bluegray-400 focus:ring-primary-500 focus:border-primary-500  disabled:text-bluegray-500 disabled:bg-gray-50"
  }
}
