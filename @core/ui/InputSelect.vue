<template>
  <select
    :value="modelValue"
    class="f-input block w-full appearance-none px-3 py-2 rounded-md border border-slate-400 placeholder-slate-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 pr-8 overflow-ellipsis overflow-hidden"
