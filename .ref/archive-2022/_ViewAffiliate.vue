...
import ProofStars from '@kaption/ui/ProofStars.vue'
import ElButton from '@kaption/ui/ElButton.vue'
import ElemIntegrations from '../@apps/site/src/_affiliate/ElemIntegrations.vue'
...
<template>
  <div class="overflow-x-hidden">
      ...
      <div class="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-40">
        ...
        >
          <div class="sm:max-w-xl mx-auto">
            <div>
              <h1
                class="text-3xl md:text-6xl font-extrabold tracking-tight lg:text-6xl"
              >
                Kaption Affiliate Program
              </h1>
              <div class="mt-6 text-slate-500 text-xl md:text-2xl">
                As a Kaption affiliate you help others experience
                high-resolution analytics and earn a recurring 30% commission
                for every marketer you send our way.
              </div>
            </div>
            <div class="my-10 flex justify-start space-x-4">
              <ElButton
                ...
                size="lg"
              >
                Join The Kaption Affiliate Program &rarr;
              </ElButton>
            </div>
        ...
        <div class="sm:mx-auto sm:max-w-3xl sm:px-6">
          ...
          >
            ...
            <!-- <span class="block mt-7 text-center text-sm text-slate-400">
              Watch the Kaption affiliate video.
            </span> -->
          </div>
        </div>
      </div>
    ...
    <section class="mx-auto max-w-7xl px-4 md:px-20 lg:px-8 text-center">
      <h1
        class="text-3xl sm:text-4xl lg:text-6xl xl:text-7xl font-extrabold m-auto"
      >
        How It Works
      </h1>
    </section>
    ...
    <section
      class="py-10 px-8 mx-auto max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center"
    >
      <div
        class="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0"
      >
        <div
          class="flex-none flex justify-center items-center rounded-full w-12 h-12 mb-6 border-2 border-primary-500 text-primary-500"
        >
        ...
        <div class="text-lg text-slate-500 lg:text-xl">
          <p class="mt-4">
            Anyone can join the Kaption affiliate program. You don’t even need
            to be a Kaption customer to promote Kaption. But to be a successful
            affiliate, you must:
          </p>
          <ul class="mt-4 space-y-4 list-inside list-decimal">
            <li>
              Understand the importance of conversion optimization and believe
              in the power of Kaption.
            </li>
            <li>
      ...
      <div class="mt-12 sm:mt-16 lg:mt-0">
        <div
          class="shadow-lg ring-1 ring-black ring-opacity-10 rounded-md px-4 py-12 mx-auto max-w-lg md:px-20 lg:px-12"
        >
          <blockquote>
            <div
              class="max-w-3xl mx-auto text-center text-xl leading-8 italic text-slate-500 py-6"
            >
              &ldquo;I love the Kaption affiliate program! It provides me with
    ...
    <section
      class="mx-auto max-w-7xl px-8 py-10 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center"
    >
      <div
        class="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0"
      >
    ...
    <section
      class="py-12 px-8 mx-auto max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center"
    >
      <div
        class="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0"
      >
        ...
        <div class="text-lg text-slate-500 lg:text-xl">
          <p class="mt-4">
            We send you a 30% commission for every person who signs up to
            Kaption through your affiliate link. But it’s not just that one
            payment when they sign up. That 30% is going to hit your bank
            account every month for as long as their Kaption account is active.
          </p>
        </div>
      </div>
      <div class="mt-12 sm:mt-16 lg:mt-0">
        ...
        >
          <div class="flex flex-col items-start mb-4">
            ...
            <div class="text-slate-500 py-6">
              ...
              <strong>{{ referralAccounts[volumeTier].accounts }} accounts</strong>
