...
import { docSetting } from '@factor/plugin-docs-engine'
import { map } from './map'
import WelcomeBanner from './__WelcomeBanner.vue'
...
const baseRoute = computed(() => {
  return docSetting('baseRoute') ?? '/docs'
})
function docRoute(docId?: string): string {
  return docId ? `${baseRoute.value}/${docId}` : ''
}
...
const groups = ['settingUp', 'analytics', 'legal']
