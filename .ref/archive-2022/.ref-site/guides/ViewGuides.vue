...
useMeta({
  title: computed(() => {
    ...
    return `${toLabel(pathName)} - Get more out of Kaption`
  }),
  meta: [
    {
      name: `description`,
      content:
        'Guides and articles to better understand user behavior, make the right changes, improve UX, and increase conversions on your website using Kaption.',
    },
  ],
})
</script>
  ...
  <div class="overflow-hidden">
    <div class="relative bg-light-50">
      <div class="bg-pattern-bottom-top-light bg-repeat-x">
        <div
          class="max-w-4xl mx-auto py-16 px-4 sm:py-32 sm:px-6 lg:px-8 lg:max-w-6xl"
        >
          <div
          ...
          >
            <div class="max-w-7xl mx-auto text-center md:px-40">
              <h2 class="text-4xl font-extrabold sm:text-7xl">
                Kaption guides to grow your business.
              </h2>
              <p class="mt-5 text-xl text-slate-500">
                Learn about user behavior, user experience, increase user
                conversion, and other knowledge from the team at Kaption about
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <dl class="grid lg:grid-cols-12 lg:gap-12">
          <router-link
            ...
            :key="guide.title"
            :to="guide.path"
            class="flex flex-col bg-white rounded-lg overflow-hidden p-6 border border-light-100 group lg:p-7"
            :class="guide.class"
          >
            <dt
              class="text-3xl mb-4 leading-tight font-extrabold group-hover:text-primary-500"
            >
              {{ guide.title }}
            </dt>
            <dd class="flex-grow text-xl pb-auto mb-auto text-slate-500">
              {{ guide.content }}
            </dd>
            <p
              class="inline-flex items-center mt-8 uppercase tracking-wider text-sm text-primary-500"
            >
              {{ guide.name }} <ElHoverArrow />
            </p>
          </router-link>
        </dl>
      </div>
