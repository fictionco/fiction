...
const btnClass = computed(() => {
  ...
  if (props.btn === 'danger') {
    ...
    out
      = 'text-white bg-primary-500 hover:bg-primary-600 focus:ring-primary-500 border-primary-500'
  }
    ...
    out
      = 'text-white  hover:bg-white hover:bg-opacity-20 border-white focus:ring-white'
  }
  else if (props.btn === 'default') {
    out
      = 'border-slate-300 text-slate-800 bg-white hover:bg-slate-50 focus:ring-primary-500'
  }
...
<template>
  <component
    ...
    :to="to"
    :href="href"
    class="relative inline-flex items-center border rounded-md shadow-sm font-medium focus:outline-none focus:ring-1 focus:ring-offset-1"
    :class="btnClass"
  >
