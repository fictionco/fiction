      ...
      <div class="stage">
        <div class="scene">
          ...
          <div class="box-1 icon-box">
            ...
            <div class="box a">
              <img src="./img/net.svg" alt="Neural">
              <div class="caption font-bold tracking-tight">
                Train
              </div>
            </div>
          </div>
          ...
          <div class="box-3 icon-box">
            ...
            <div class="box">
              <img src="./img/nvidia.svg" alt="NVidia">
              <div class="caption font-bold tracking-tight">
                Design
              </div>
            </div>
...
figure.figure-powered {
  ...
  .stage {
    ...
    .scene {
      ...
      transform: rotateX(50deg) rotateY(0deg) rotate(25deg) scale(1.2)
