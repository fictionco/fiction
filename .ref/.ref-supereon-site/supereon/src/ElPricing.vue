    ...
    >
      <div class="relative mx-auto max-w-screen-xl text-center">
        <div class="relative z-10 mx-auto max-w-xl">
          ...
          <h1
            class="font-cal mt-2 max-w-2xl text-3xl font-extrabold sm:text-4xl lg:text-6xl"
          >
            {{ title }}
          </h1>
          <div class="mt-3 text-xl sm:mt-5 sm:text-2xl">
                  ...
                  <div class="bg-theme-0 px-4 pb-4 pt-8">
                    <div>
                      <div class="mt-4 flex items-center justify-center">
                        ...
                        >
                          <span
                            class="font-brand mr-2 mt-1 text-3xl font-bold tracking-tight"
                          >$</span>
                          <span
