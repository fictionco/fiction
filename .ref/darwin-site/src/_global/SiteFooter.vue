<template>
  <footer
    :class="darkMode ? 'bg-primary-900' : 'bg-primary-700'"
    ...
    <div class="max-w-7xl mx-auto px-4 lg:px-0">
      <div
        class="
          ...
          justify-between
          flex-col
          lg:py-36 lg:px-12 lg:flex-row
        "
      >
        <div class="">
          <a href="https://www.darwin.so"
            ><ElemLogo mode="icon" class="h-12 w-auto scheme-light"
          /></a>
        </div>
        <div v-for="(col, i) in columns" :key="i" class="mt-16 lg:mt-0">
          <h3
            v-if="col.heading"
            class="
              mb-4
              text-center text-sm text-primary-300
              uppercase
          ...
          <ul v-if="col.menu" :class="col.class ? col.class : 'space-y-2'">
            <li
            ...
            >
              <a
                ...
                class="text-base text-primary-400 hover:text-primary-200"
              >
                {{ item.name }}
              </a>
            </li>
      ...
      <div
        class="
          ...
          lg:pb-36
          text-sm text-center
          lg:px-12 lg:flex-row lg:items-center lg:justify-between
        "
      >
        <ul class="m-0 p-0 flex mx-auto lg:mx-0">
          <li
        ...
        <div class="text-xs mx-auto mt-5 lg:mt-0 lg:mx-0 text-white">
          <div>
...
import stripeVerified from "../img/stripe-verified.svg"
    ...
    const columns = ref([
      {
        heading: "Features",
        menu: [
          { path: "/features/dashboards", name: "Smart Dashboards" },
          {
            path: "/features/ab",
            name: "AB Analytics",
          },
          ...
          { path: "/features/heatmaps", name: "Live Heatmaps" },
          { path: "/features/realtime", name: "Real-time Data" },
          { path: "/features/behavior", name: "Behavioral Analytics" },
          { path: "/features/conversion", name: "Conversion Tracking" },
          { path: "/features/bots", name: "Bot Flagging" },
          { path: "/features/performance", name: "Debugging" },
        ],
      },
      {
        heading: "Company",
