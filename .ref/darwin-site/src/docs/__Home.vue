...
export default {
  ...
  setup() {
    ...
    const socials = [
      ...
      {
        title: "Facebook",
        description: "Updates and Darwin news on Facebook",
      ...
      },
      {
        ...
        path: "https://join.slack.com/t/darwin-analytics/shared_invite/zt-rrr512dj-xh_wEGr7cAqOy4nXxT7aRA",
    ...
    return { socials, groupList, docRoute }
  },
}
</script>
