...
const columns = vue.ref<Column[]>([
  {
    heading: 'Feedback',
    menu: featureGroups.feedback,
  },
  {
    heading: 'Marketing',
    menu: featureGroups.marketing,
  },
  {
    heading: 'Analytics',
    menu: featureGroups.analytics,
  },
  {
    heading: 'Resources',
    menu: [
...
<template>
  <footer
    :class="
      darkMode
        ? 'bg-dark-900'
        : 'text-white bg-gradient-to-br from-slate-900 via-black to-slate-900 '
    "
  ...
  >
    ...
    <div class="mx-auto max-w-7xl px-4 lg:px-0">
      ...
      >
        <div class="mx-auto w-80 py-6 text-center md:py-1">
          <a href="https://www.kaption.co">
            <KaptionLogo class="scheme-light inline-block h-6" />
          </a>
        </div>
        <div class="grid grow grid-cols-12 gap-x-8 gap-y-12">
          ...
          >
            <h3
              v-if="col.heading"
              class="text-primary-300 mb-2 text-center text-sm uppercase tracking-wider lg:mb-3 lg:text-left"
            >
              {{ col.heading }}
            </h3>
            <ul v-if="col.menu" :class="col.class ? col.class : 'space-y-2'">
              ...
              >
                <a
                  ...
                  class="hover:text-primary-200 text-base text-white"
                >
                  {{ item.name }}
                </a>
              </li>
      ...
      <div
        class="flex flex-col pb-12 text-center text-sm lg:flex-row lg:items-center lg:justify-between lg:px-12 lg:pb-36"
      >
