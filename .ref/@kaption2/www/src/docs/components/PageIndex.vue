...
const metaTitle = 'Kaption Analytics Documentation and Guides'

const metaDescription
  = 'Get started quickly and explore everything you can do with Kaption Analytics.'
...
const socials = [
  {
    title: 'LinkedIn',
    description: 'Professional discussion, tips and tricks on LinkedIn',
    path: 'https://bit.ly/38I4k1j',
  ...
  {
    title: 'Facebook',
    description: 'Updates and Kaption news on Facebook',
    path: 'https://bit.ly/3nPtj8q',
...
const groupsToShow = ['settingUp', 'analytics', 'legal']
...
<template>
  <div>
    <div class="px-4 pt-32 pb-48 sm:px-6 xl:px-8">
      <div class="my-6">
        <h1 class="mb-4 text-3xl font-bold">
          Documentation
        </h1>
        <p class="text-xl text-theme-500">
          Explore everything you can do with Kaption.
        </p>
      </div>
        ...
        >
          ...
          >
            <div class="flex w-full md:flex-col">
              ...
              >
                <div class="mr-8">
                  <div class="text-primary-500 h-12 w-12" v-html="group.icon" />
                </div>
                <div class="">
      ...
      <section>
        <div class="mt-16 mb-8">
          ...
          <p class="mt-2 text-lg text-theme-500">
            ...
            ><div
             ...
             >
              ...
              <div class="flex-1">
                ...
                <p class="text-theme-500">{{ social.description }}</p>
              </div>
            </a>
          </li>
        </ul>
