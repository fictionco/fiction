...
<template>
  <div class="trust-badge mt-8 border-t border-slate-200 pt-4">
    <div class="justify-between text-theme-300 sm:flex">
      ...
      <div class="mt-4 flex items-center text-xs text-theme-800 sm:mt-0">
		...
		c11.9,0,20.9-2.7,27.7-6.5v-20c-6.8,3.4-14.6,5.5-24.5,5.5c-9.7,0-18.3-3.4-19.4-15.2h48.9C413.8,121,414,115.8,414,113.4z M364.6,103.9c0-11.3,6.9-16,13.2-16c6.1,0,12.6,4.7,12.6,16H364.6z"
            />
            <path
              fill="currentColor"
