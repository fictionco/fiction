      ...
      <div class="absolute inset-0 overflow-hidden">
        ...
        >
          ...
          >
            <div
              v-if="vis"
              class="relative z-30 w-screen max-w-lg"
              @click.stop
            >
              <button
                class="absolute right-8 top-8 rounded-md text-theme-500 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white"
                @click.prevent="close()"
              >
