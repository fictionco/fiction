  ...
  <AdminPage format="full">
    ...
    >
      ...
      <div class="flex items-center text-xs">
        <a
          ...
          @click="vis = false"
        >
          <span class="uppercase">Open WebUI in New Window</span>
        </a>
      </div>
    </div>
    <ElPanel v-if="!url" class="my-12">
      <ElServerManager
        ...
        description="Stable Diffusion Web UI by Automatic1111. This software runs on your AI server and can be used to edit images with AI."
      />
    </ElPanel>
    <iframe
      v-else
