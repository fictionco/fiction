      ...
      <div class="z-50 mx-auto max-w-screen-xl py-16">
        <div class="px-4 lg:flex">
          <div class="w-full lg:mr-[3%] lg:w-[53%]">
            <div class="mb-6">
              <RouterLink
                class="bg-primary-50 border-primary-500 text-primary-600 inline-block rounded-full border px-4 py-1 text-[11px] font-bold uppercase tracking-wide"
                to="/tour"
              >
                Control Your Future ↘︎
              </RouterLink>
            </div>
            <h2
              class="text-theme-800 text-3xl font-extrabold tracking-tighter md:text-8xl"
            >
            ...
            >
              <span class="text-theme-700 font-semibold tracking-tight"><h1 class="font-semibold">
                Create a beautiful personal website, capture emails, and monetize your audience.
