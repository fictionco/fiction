...
describe('email actions', async () => {
  ...
  const kit = await createUiTestingKit({ headless: false, envFiles: [testEnvFile], setup, slowMo: 70000 })
  ...
  //         margin-bottom: 2rem; border-color: rgb(222,223,226);" class="dark:border-gray-700"><div data-id="__vue-email-markdown" class="body-content"><p data-id="vue-email-text" style="font-size:1.1rem;line-height:1.65;font-weight:normal">Verify your email using the code: <strong data-id="vue-email-text" style="font-weight:bold">951894</strong> or click the button below.</p></div><table align="center" width="100%" data-id="__vue-email-section" border="0" cellpadding="0" cellspacing="0" role="presentation" class="mt-12 mb-8 text-left" style="margin-top: 3rem; margin-bottom: 2rem; text-align: left;"><tbody><tr><td><table align="center" width="100%" data-id="__vue-email-section" border="0" cellpadding="0" cellspacing="0" role="presentation" class="inline-block" style="display: inline-block;"><tbody><tr><td><td data-id="__vue-email-column" role="presentation" class=""><a data-id="__vue-email-button" style="line-height:100%;text-decoration:none;display:inline-block;max-width:100%;white-space:nowrap; background-color: rgb(37,99,235); color: rgb(255,255,255); padding-top: 0.75rem;
  //         padding-bottom: 0.75rem; padding-left: 1rem;
  //         padding-right: 1rem; border-radius: 0.375rem; font-size: 16px; font-weight: 700; user-select: none;" href="http://localhost:1413/_action/verify-email/?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoic3Vic2NyaWJlciIsInVzZXJJZCI6InVzcjY2NGQ0MWVkYWI1MWJiMzgyMjFkNDgzOSIsImVtYWlsIjoiYXJwb3dlcnMrNTE0MDY0NDQyM0BnbWFpbC5jb20iLCJpYXQiOjE3MTYzMzkxODF9.N66aibwgZgUkmdyf9deAgo6387ElATcSJgxWf-IB5FE&amp;" target="_blank" class="dark:bg-blue-600 hover:opacity-80">Verify Email</a></td></td></tr></tbody></table></td></tr></tbody></table><hr data-id="__vue-email-hr" style="width:100%;border:none;border-top:1px solid #eaeaea; margin-top: 3rem;
