        ...
        createCard({
          ...
          cards: [
            createCard({
              ...
              userConfig: { isNavItem: true, navIcon: 'i-heroicons-building-office-2', navIconAlt: 'i-heroicons-building-office-2-20-solid' },
            }),
            createCard({
              slug: 'newOrg',
...
export async function setup(args: { fictionEnv: FictionEnv }) {
  ...
  const pg = fictionEnv.runHooks('adminPages', pages(), { templates })
