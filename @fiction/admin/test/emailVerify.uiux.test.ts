    ...
    expect(r.emailVars).toMatchInlineSnapshot(`
      {
        ...
        "callbackUrl": "http://localhost:14490/__transaction/verify-email?code=299534&token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoic3Vic2NyaWJlciIsInVzZXJJZCI6InVzcjY2NTZlMDc2NDIzNjI4NTQ0NTgwZjUyNyIsImVtYWlsIjoiYXJwb3dlcnMrODQwODU4OTMzN0BnbWFpbC5jb20iLCJpYXQiOjE3MTY5Njk1OTB9.F_sRZQjahe4632sNXbRo0WoYH-oRabm_yQy23janh7s&email=arpowers%2B8408589337%40gmail.com",
        "code": "299534",
        ...
        "unsubscribeUrl": "http://localhost:14490/__transaction/unsubscribe",
    ...
    expect(v).toMatchInlineSnapshot(`
      {
        "actionId": "verifyEmail",
        "appName": "Test Fiction App",
        "callbackUrl": "http://localhost:[port]/__transaction/verify-email?code=[code]&token=[token]&email=[email]",
        "code": "[code]",
        "email": "[email]",
        "fullName": "Doctor Waffles",
