...
import type { ActionItem, MediaItem, vue } from '@fiction/core'
...
const props = defineProps({
  items: { type: Array as vue.PropType<MediaItem[]>, required: true },
...
<template>
  <div>
    ...
    <div v-else class="p-6">
      ...
      >
        <div>
          <div v-if="!item.media" class="flex items-center justify-center size-12" :class="mediaClass">
