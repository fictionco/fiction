...
export function getColorThemeStyles(theme: ColorTheme = 'theme') {
  const cls = {
    ...
    blue: { text: 'text-blue-600 dark:text-blue-400', bg: 'bg-blue-50 dark:bg-blue-400/20', ring: 'ring-blue-500/50 dark:ring-blue-400/40 ', border: 'border-blue-500/50 dark:border-blue-400/20', hover: 'hover:bg-blue-100 dark:hover:bg-blue-700', active: 'active:bg-blue-200 dark:active:bg-blue-600' },
