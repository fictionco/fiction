...
const availableTools = [
  ...
  { label: 'Custom HTML', value: 'html', icon: 'i-tabler-code', component: undefined },
...
const currentSelection = vue.ref<MediaObject>({
  ...
  format: props.modelValue?.format || 'url',
})
    ...
    <div data-test-id="media-modal" class="bg-white text-theme-900 dark:bg-theme-900 dark:text-theme-100 rounded-lg overflow-hidden">
      ...
      <div class="flex min-h-[500px]">
        ...
        <div class="flex-1 flex flex-col">
          ...
          <div class="p-4 border-b border-theme-200 dark:border-theme-700 h-64">
            <div class="relative h-full">
              <div class="w-full h-full flex items-center justify-center">
                <template v-if="currentSelection.format">
                  <XLogo
          ...
          <!-- Tool Content Area -->
          <div class="flex-1 p-4 bg-theme-50/50 dark:bg-theme-800/50">
            <div class="text-xs text-theme-500 dark:text-theme-400 mb-4">
              Set to New Media
            </div>
