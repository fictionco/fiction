...
import FigureDashboard from './fig/FigureDashboard.vue'
import FigureLiveChanges from './fig/FigureLiveChanges.vue'
      ...
      >
        ...
        >
          <div class="max-w-full px-6 pt-12 pb-4 lg:max-w-xl lg:py-40">
            ...
            <h2 class="mb-6 text-6xl tracking-tight font-bold x-font-title">
              {{ feature.title }}
            </h2>
            <div class="mb-4 text-3xl text-theme-500 dark:text-theme-100 leading-relaxed text-balance ">
              {{ feature.text }}
            </div>
          </div>
        </div>
