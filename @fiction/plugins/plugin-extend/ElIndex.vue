...
<template>
  <div class="divide-y divide-theme-300/50 overflow-hidden rounded-lg bg-theme-300/50 border border-theme-300/60 sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0">
    <div v-for="(item, i) in list" :key="i" class="rounded-tl-lg rounded-tr-lg sm:rounded-tr-none group relative bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
      <div>
      ...
      <div class="mt-8">
        <h3 class="text-base font-semibold leading-6 text-theme-900">
        ...
        <p class="mt-2 text-sm text-theme-500">
          {{ item.desc }}
        </p>
      </div>
      <span class="pointer-events-none absolute right-6 top-6 text-theme-300 group-hover:text-theme-400" aria-hidden="true">
        <div class="i-heroicons-plus text-3xl" />
      </span>
    </div>
