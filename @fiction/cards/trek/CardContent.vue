...
<template>
  <div class="space-y-4">
    ...
    >
      <div :key="itemIndex">
        <div class="space-y-3">
          <CardText :card :path="`items.${itemIndex}.header`" tag="h2" class="font-semibold x-font-title text-xl md:text-2xl xl:text-4xl text-pretty" />
          <CardText :card :path="`items.${itemIndex}.subHeader`" tag="p" class="text-lg md:text-xl xl:text-3xl text-pretty" />
        </div>
