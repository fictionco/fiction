...
<template>
  <div class="socials flex space-x-6 text-2xl">
    <a v-for="(item, i) in socials" :key="i" :href="item.href" target="_blank" class="text-center flex items-center flex-col justify-end hover:text-primary-500 dark:hover:text-primary-400">
