  ...
  new InputOption({
    ...
    options: [
      ...
      new InputOption({ key: 'actions', label: 'Actions', input: 'InputList', options: [
        ...
        new InputOption({ key: 'icon', label: 'Icon (Left)', input: 'InputLibraryIcon', description: 'Use format i-tabler-[icon], check docs for info' }),
        new InputOption({ key: 'iconAfter', label: 'Icon (Right)', input: 'InputLibraryIcon', description: 'Use format i-tabler-[icon], check docs for info' }),
      ] }),
    ],
  }),
