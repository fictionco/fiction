...
describe('detectRecursivePath', () => {
  ...
  it('returns false for long segments without repetition', () => {
    ...
    expect(regex.test('edit-site?siteId=sit67c2a98fdc9888419365c886&_scheme=toggle')).toBe(false)
    ...
    const demo = `/app/edit-site?siteId=sit67c2a98fdc9888419365c886?_scheme=toggle`
    expect(detectRecursivePath({ pathname: demo })).toBe(false)
  })
