        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                <div id="content">
                    <h1>XML Sitemap</h1>
                    <p class="desc">
                        This is a sitemap generated by <a href="https://www.fiction.com">Fiction</a> to help search engines discover app content.
                    </p>
                    ...
                    <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
                        ...
                        <p class="desc"><a href="/sitemap.xml" class="back-link">Sitemap Index</a></p>
                    </xsl:if>
                </div>
            </body>
        </html>
