...
export function getImageStyles() {
  return [
    ...
    },
    {
      value: 'bauhaus',
      label: 'Bauhaus',
      subLabel: 'Functional Precision',
      info: 'Clean geometric style with bold primary colors and functional forms, inspired by Bauhaus principles, Walter Gropius, László Moholy-Nagy, Herbert Bayer',
    },
    {
      value: 'midCenturyModern',
      label: 'Mid-Century Modern',
      subLabel: 'Sleek Optimism',
      info: 'Streamlined style with organic shapes, muted tones, and retro elegance, Charles Eames, Eero Saarinen, Alexander Girard',
    },
    {
      value: 'constructivism',
      label: 'Constructivism',
      subLabel: 'Dynamic Efficiency',
      info: 'Bold style with angular compositions and industrial energy for impactful clarity, El Lissitzky, Alexander Rodchenko, Vladimir Tatlin',
    },
    {
      value: 'swissStyle',
      label: 'Swiss Style',
      subLabel: 'Grid-Based Clarity',
      info: 'Minimal style with strict grids, sans-serif typography, and asymmetrical balance, Josef Müller-Brockmann, Max Bill, Armin Hofmann',
    },
    {
      value: 'deStijl',
      label: 'De Stijl',
      subLabel: 'Harmonious Abstraction',
      info: 'Bright, abstract style with horizontal and vertical lines, neon colors, and balanced simplicity, Piet Mondrian, Theo van Doesburg, Gerrit Rietveld',
    },
    {
      value: 'corporateArtDeco',
      label: 'Corporate Art Deco',
      subLabel: 'Refined Opulence',
      info: 'Bright, elegant style with symmetrical geometry, sharp metallic accents, and luxurious restraint, Tamara de Lempicka, Erte Tirtoff, Rockwell Kent',
    },
    {
      value: 'futurism',
      label: 'Futurism',
      subLabel: 'Forward Momentum',
      info: 'Dynamic style with sharp angles and vibrant energy, evoking innovation, Umberto Boccioni, Giacomo Balla, Fortunato Depero',
    },
    {
      value: 'monochromeEtching',
      label: 'Monochrome Etching',
      subLabel: 'Timeless Sophistication',
      info: 'Refined style with intricate linework and grayscale tones for understated elegance, Rembrandt, Giovanni Battista Piranesi, James McNeill Whistler',
    },
    {
      value: 'watercolor',
      label: 'Watercolor',
