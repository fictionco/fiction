  ...
  describe('sends a transactional email', async () => {
    ...
    it('renders markdown content', async () => {
      ...
      expect(result.data.bodyMarkdown).toMatchInlineSnapshot(`
        ...
        Astronomers use the formula \`d = v × t\` to calculate cosmic distances, where d is distance, v is velocity, and t is time.
        ...
        **Check out these amazing photos** of the recent solar eclipse taken from the [International Space Station](https://www.fiction.com). Witness the awe-inspiring beauty of our universe.
            ...
            // JavaScript code to calculate light-years
        ...
        **🌟 Editor's Pick:** Don't miss our exclusive interview with veteran astronaut Sarah Chen about life aboard the ISS!
        ...
        [Explore Space Tech](https://www.fiction.com/space-tech)
        ...
        Finally, after months of preparation, the crew is ready to embark on their journey to Mars<sup id="fnref1"><a href="#fn1">1</a></sup>. **Stay tuned** for live updates and exclusive coverage!

        ---

        1.  Mission details available at [fiction.com/mars-mission](https://www.fiction.com/mars-mission) [↩](#fnref1)"
      `)
    })
    ...
    it('renders html content', async () => {
      expect(result.data?.html).toMatchInlineSnapshot(`
        ...
        </div><!-- Buttons --><div style="margin:32px 0;"><!--[--><a href="#" class="x-button">Confirm email address &#x2192;</a><!--]--></div></div><hr style="border:none;border-top:1px solid #b3b9c5;margin:3em 0; width: 5em;"><!-- Footer --><div id="themed-footer" style="margin-top:2em;"><!-- Footer Links --><div style="margin-bottom:32px;"><!--[--><a href="https://www.fiction.com" style="margin-right:16px;font-weight:600;color:inherit;font-size:13px;">View Website</a><!--]--></div><!-- CompanyName Info --><div style="font-size:13px;"><div>© 2025 </div><div style="margin-top:4px;">1234 Fiction St, Fiction City, FI 12345</div></div><!-- Legal Footer --><table id="last-line" style="width:100%;margin-top:32px;" cellpadding="0" cellspacing="0"><tbody><tr><td><a href="https://www.fiction.com/unsubscribe">Unsubscribe</a><span>•</span><a href="mailto:admin@fiction.com">Report Abuse</a></td><td style="text-align:right;"><a href="https://www.fiction.com" target="_blank" rel="noopener"> Created with Fiction.com </a></td></tr></tbody></table></div></div></div>
