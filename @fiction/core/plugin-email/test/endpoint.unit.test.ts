  ...
  describe('sends a transactional email', async () => {
    ...
    it('renders html content', async () => {
      expect(result.data?.html).toMatchInlineSnapshot(`
        "<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><tailwind-clean-component env="test" campaignId="xmqad" toUserId="usr676fb24ba788c7120d18585b" fromOrgId="org676fb24bde73011838a1384c"><html lang="en" dir="ltr" class="" style=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/><meta name="x-apple-disable-message-reformatting"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/><title>Test Space (test email 🧪🧪🧪)</title><meta name="description" content="Welcome to Space 🚀 -- This is a test email to test formatting of various elements.🧪"/><style data-id="__vue-email-style">
