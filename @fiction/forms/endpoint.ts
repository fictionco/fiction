...
import type { FormSubmissionConfig } from './schema.js'
...
abstract class FormSubmissionQuery extends Query<FormSubmissionSettings> {
...
export class QueryManageSubmission extends FormSubmissionQuery {
  limit = 40
  offset = 0
