...
import type { MenuGroup, vue } from '@factor/api'
    ...
    <div class="mx-auto max-w-7xl px-4 lg:px-0">
      <div class="">
        <div class="flex flex-col justify-between py-16 sm:flex-row lg:px-12">
          <div class="w-72 shrink-0 py-6 text-left sm:mx-auto md:py-1">
            <a href="/" v-html="settings.icon" />
          </div>
          <div class="grid grow grid-cols-12 gap-x-8 gap-y-12">
            <div
              v-for="(col, i) in settings.menus"
              :key="i"
              ...
              <ul v-if="col.menu" :class="col.class ? col.class : 'space-y-3'">
                ...
                >
                  <a
                    ...
                    class="hover:text-primary-500 text-theme-800 font-sans text-sm font-semibold"
                  >
                    {{ item.name }}
                  </a>
                </li>
            ...
            >
              <ul class="m-0 mx-auto flex justify-end p-0 lg:mx-0">
                <li
                  v-for="(item, i) in settings.socialList"
                  :key="i"
                ...
                >
                  ...
                  >
                    ...
                    <div
                      class="text-theme-700 hover:opacity-80"
                      v-html="item.icon"
                    />
                  </a>
                </li>
              ...
              <div class="text-theme-700 mt-5 text-right text-xs">
                <svg
                  class="inline-block"
