...
const socials = [
  {
    title: 'Support Forum',
    description: 'Professional discussion, tips and tricks',
    path: 'https://forum.fiction.com',
...
<template>
  <div>
    <div class="px-4 pb-32 sm:px-6 xl:px-8">
      <div class="my-6">
        <h1 class="mb-4 text-3xl font-bold">
          Documentation
        </h1>
        <p class="text-theme-500 text-xl">
      ...
      <section class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:gap-8">
        <div
          v-for="(group, groupId) in Object.values(groupList).filter(
            (_) => _.title,
          )"
          :key="groupId"
          class="flex"
      ...
      <section>
        <div class="mt-16 mb-8">
          ...
          <p class="text-theme-500 mt-2 text-lg">
