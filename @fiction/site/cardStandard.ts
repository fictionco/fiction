...
export function standardCardOptions(args: { card: Card }) {
  ...
  return new InputOption({ key: 'standard', label: 'Standard Options', input: 'group', options: [
    new InputOption({ key: 'contentGen', icon: 'i-tabler-sparkles', isClosed: true, label: 'AI Content Generation', input: 'group', options: [
      new InputOption({ key: 'purpose', input: InputAi, isUtility: true, props: { site: card.site } }),
    ] }),
    new InputOption({ key: 'standardHeaders', icon: 'i-tabler-heading', isClosed: true, label: 'Text Headers', input: 'group', options: [
    ...
    new InputOption({ key: 'standardFont', icon: 'i-tabler-text-size', isClosed: true, label: 'Font', input: 'group', options: [
    ...
    new InputOption({ key: 'standardHandling', icon: 'i-tabler-status-change', isClosed: true, label: 'Page Handling', input: 'group', options: [
