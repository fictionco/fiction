              ...
              items: [
                {
                  superTitle: {
                    theme: 'orange',
                    text: 'AI Tools for Your Personal Brand',
                    icon: { class: 'i-tabler-user-circle' },
                  },
                  title: `Create Your [@text_effect type=line]Digital Self[/@text_effect].`,
                  subTitle: `Communicate your expertise, capture leads, set meetings, and build your audience while you sleep.`,
                  action: {
                    buttons: [
                      {
